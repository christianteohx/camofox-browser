...
function loadConfig() {
  return {
    ...
    // null = auto-discover from default dirs; string = explicit override
    helpersDir: process.env.CAMOFOX_HELPERS_DIR || null,
    defaultHelpersDirs: [
      join(os.homedir(), '.camofox', 'helpers'),
      join(process.cwd(), 'helpers'),
    ],
    ...
    serverEnv: {
      ...
      CAMOFOX_HELPERS_DIR: process.env.CAMOFOX_HELPERS_DIR,
